namespace RegOnline.RegressionTest.Keyword
{
    ...
    {
        public void AddEarlyPrice(EarlyPrice earlyPrice, DataCollection.EventData_Common.Location location)
        {
            switch (location)
            {
                case DataCollection.EventData_Common.Location.RegType:
                    ...
                    {
                        case DataCollection.EventData_Common.EarlyPriceType.DateAndTime:
                            ...
                            break;
                        case DataCollection.EventData_Common.EarlyPriceType.Registrants:
        ...
        public void AddLatePrice(LatePrice latePrice, DataCollection.EventData_Common.Location location)
        {
            switch (location)
            {
                case DataCollection.EventData_Common.Location.RegType:
