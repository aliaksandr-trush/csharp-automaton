namespace RegOnline.RegressionTest.Fixtures.New.FeeOptions
{
    ...
    public class AccessCodeFixture : FixtureBase
    {
        ...
        public void TestAccessCode()
        {
            ...
            ac2.CodeType = DataCollection.EventData_Common.CustomFieldCodeType.AccessCode;
            ...
            ac3.CodeType = DataCollection.EventData_Common.CustomFieldCodeType.AccessCode;
            ac3.Limit = 2;
            CustomFieldCode ac4 = new CustomFieldCode("ac4");
            ac4.CodeType = DataCollection.EventData_Common.CustomFieldCodeType.AccessCode;
            ...
            ac5.CodeType = DataCollection.EventData_Common.CustomFieldCodeType.AccessCode;
            ...
            Assert.True(KeywordProvider.Register_Common.GetTotal(DataCollection.EventData_Common.RegisterPage.Confirmation) == 240);
