namespace RegOnline.RegressionTest.Fixtures.xAuth
{
    ...
    public class OnsiteKioskWithxAuthRegTypeFixture : ExternalAuthenticationFixtureBase
    {
        ...
        {
            Assert.AreEqual("0 record(s) found.", UIUtil.DefaultProvider.GetText("//div[@class='regHeader']", LocateBy.XPath));
        }
        ...
        private void VerifyIncorrectMessageShowUp()
        {
            ...
            string actualMessage = UIUtil.DefaultProvider.GetText("//div[@id='ctl00_cph_valSummary']/ul/li", LocateBy.XPath);
        ...
        {
            Assert.AreEqual("You are already checked-in.", UIUtil.DefaultProvider.GetText("//div[@id='ctl00_cph_divMessage']/span[@class='prompt']", LocateBy.XPath));
        }
    }
}
