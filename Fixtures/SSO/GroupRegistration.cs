namespace RegOnline.RegressionTest.Fixtures.SSO
{
    ...
    public class GroupRegistration : ExternalAuthenticationFixtureBase
    {
        ...
        public void GroupRegisterSSO()
        {
            ...
            reg2.RegType_Response = new RegTypeResponse(regType3);
            ...
            PageObject.PageObjectProvider.Register.RegistationSite.Checkin.SelectRegTypeRadioButton(reg2.RegType_Response.RegType);
            PageObject.PageObjectProvider.Register.RegistationSite.Continue_Click();
        ...
        public void GroupRegisterNoneSSO()
        {
            ...
            reg1.RegType_Response = new RegTypeResponse(regType3);
            ...
            Registrant reg2 = new Registrant(evt);
            reg2.RegType_Response = new RegTypeResponse(regType4);
