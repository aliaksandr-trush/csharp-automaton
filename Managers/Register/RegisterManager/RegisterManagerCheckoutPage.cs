namespace RegOnline.RegressionTest.Managers.Register
{
    ...
    public partial class RegisterManager : ManagerBase
    {
        ...
        public void VerifyCheckoutTotal(double totalToVerify, Utilities.MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutTotal, LocateBy.XPath);
        ...
        public void VerifyCheckoutShippingFee(double subTotalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutShippingFee, LocateBy.XPath);
        ...
        public void VerifyCheckoutLodgingFeeTotal(double subTotalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutLodgingFeeSubTotal, LocateBy.XPath);
        ...
        public void VerifyCheckoutLodgingBookingFeeTotal(double subTotalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutLodgingBookingFee, LocateBy.XPath);
        ...
        public void VerifyCheckoutSerivceFee(double subTotalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutServiceFee, LocateBy.XPath);
        ...
        public void VerifyCheckoutMembershipRecurringSubtotal(double subTotalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutRecurringSubtotal, LocateBy.XPath);
        ...
        {
            string expectedAmount = MoneyTool.FormatMoney(taxAmountToVerify, currency);
            string actualAmount = UIUtil.DefaultProvider.GetText(string.Format(CheckoutRecurringTax, taxLabel), LocateBy.XPath);
            VerifyTool.VerifyValue(expectedAmount, actualAmount, taxLabel + " = {0}");
        }
        ...
        public void VerifyCheckoutMembershipRecurringTotal(double totalToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutMembershipYearlyFees, LocateBy.XPath);
        ...
        public void VerifyCheckoutMembershipRecurringSaving(double savingToVerify, MoneyTool.CurrencyCode currency = MoneyTool.CurrencyCode.USD)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutMembershipDiscountMessage, LocateBy.XPath);
        ...
        public void VerifyCheckoutMembershipRecurringDate(string date)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CheckoutMembershipRenewalDate, LocateBy.XPath);
        ...
        public void VerifyCheckoutCurrentBalance(double expectedAmount)
        {
            ...
            actualValue = UIUtil.DefaultProvider.GetText(CurentBalanceCheckoutLocator, LocateBy.XPath);
        ...
        public string CheckoutVerifyValue(CheckoutVerifyColumn column, int regNum)
        {
            ...
            if ((regNum >= 1) && (UIUtil.DefaultProvider.IsElementPresent(locator, LocateBy.XPath)))
            {
                valueFound = UIUtil.DefaultProvider.GetText(locator, LocateBy.XPath);
            }
            else
            {
                valueFound = null;
        ...
        {
            UIUtil.DefaultProvider.WaitForElementPresent("//strong[text() = 'Make Changes to Merchandise']", LocateBy.XPath);
            UIUtil.DefaultProvider.WaitForDisplayAndClick("//strong[text() = 'Make Changes to Merchandise']", LocateBy.XPath);
        }

        [Step]
        public void ClickCheckoutActiveWaiver()
        {
            UIUtil.DefaultProvider.WaitForDisplayAndClick("ctl00_cph_chkAITerms", LocateBy.Id);
        }

        public void ClickTermsAndConditions()
        {
            UIUtil.DefaultProvider.WaitForDisplayAndClick(CheckoutTermsAndConditionsLocator, LocateBy.Id);
        }
        ...
        public void VerifyCheckoutGroupDiscountSavings(double savingToVerify)
        {
            ...
            UIUtil.DefaultProvider.VerifyOnPage(this.OnCheckoutPage(), "Checkout");

            foundValue = UIUtil.DefaultProvider.GetText(CheckoutDiscountMessage, LocateBy.XPath);
        ...
        {
            return UIUtil.DefaultProvider.IsElementPresent(CheckoutDiscountMessage, LocateBy.XPath);
        }

        public void SetMembershipAutomaticRenewalCheckbox(bool automaticallyRenew)
        {
            UIUtil.DefaultProvider.SetCheckbox(CheckoutMembershipAutoRenew, automaticallyRenew, LocateBy.Id);
        }
        ...
        {
            if (UIUtil.DefaultProvider.IsElementDisplay(CheckoutPaymentMethod, LocateBy.Id))
            {
                UIUtil.DefaultProvider.SelectWithText(CheckoutPaymentMethod, customMethod, LocateBy.Id);
            }
        }
        ...
        public void VerifyPaymentWaitlistMessage()
        {
            ...
            VerifyTool.VerifyValue(
                ...
                UIUtil.DefaultProvider.GetText(locator, LocateBy.XPath), 
        ...
        public void VerifyAgendaItemWaitlistMessage(string agendaItemName)
        {
            ...
            VerifyTool.VerifyValue(UIUtil.DefaultProvider.GetText(locator, LocateBy.XPath), "Waitlisted", "Waitlist Message: {0}");
        }
        #endregion
        ...
        {
            string actual = UIUtil.DefaultProvider.GetValue(CCAmountLocatorNew, LocateBy.Id);
            decimal ret;
            ...
            if (UIUtil.DefaultProvider.GetValue(CCAmountLocatorNew, LocateBy.Id) != actual)
                UIUtil.DefaultProvider.Type(CCAmountLocatorNew, actual, LocateBy.Id);
        }
        #endregion

        public void ChangeCheckoutCCCountry(string country)
        {
            UIUtil.DefaultProvider.SelectWithText(CheckoutCCCountryLocator, country, LocateBy.Id);
        }
            ...
            bool checkRequiredOption)
        {
            ...
            string imgClass = UIUtil.DefaultProvider.GetAttribute(loc, "class", LocateBy.XPath);
